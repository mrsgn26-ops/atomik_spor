...
abstract class AppLocalizations {
  ...
  /// No description provided for @showCalendarButton.
  ///
  /// In en, this message translates to:
  /// **'Show My Calendar'**
  ...
  /// No description provided for @habitCompletionSummary.
  ///
  /// In en, this message translates to:
  /// **'{completed} of {total} habits completed'**
  String habitCompletionSummary(int completed, int total);

  /// No description provided for @habitInstructions.
  ///
  /// In en, this message translates to:
  /// **'Tap a habit to mark it as done.'**
  String get habitInstructions;

  /// No description provided for @habitMorningStretch.
  ///
  /// In en, this message translates to:
  /// **'Morning stretch'**
  ...
  /// No description provided for @habitHydrate.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @headlineSystemNotGoals.
  ///
  /// In en, this message translates to:
  /// **'Systems, not goals.'**
  String get headlineSystemNotGoals;

  /// No description provided for @sub6minStart.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @btnChangeLang.
  ///
  /// In en, this message translates to:
  /// **'Change Language'**
  ...
  /// In en, this message translates to:
  /// **'Current streak'**
  String get labelCurrentStreak;

  /// No description provided for @labelBestStreak.
  ///
  /// In en, this message translates to:
  /// **'Best streak'**
  String get labelBestStreak;

  /// No description provided for @labelPerfectStreak.
  ///
  /// In en, this message translates to:
  /// **'Perfect streak'**
  String get labelPerfectStreak;
